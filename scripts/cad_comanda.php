...
include '../conexao.php';
	...
	$sql_servcomanda = mysqli_query($conexao, "INSERT INTO serv_comanda (qtd_serv, id_com, id_servico)  VALUES ('$qtd_servico','$id_comanda','$servico')"); 
	
	//INSERÇÃO NA TABELA PROD_COMANDA
	$sql_prodcomanda = mysqli_query($conexao, "INSERT INTO prod_comanda
 				(qtd_prod, id_com, id_produto)  VALUES ('$qtd_produto','$id_com','$produto')"); 
