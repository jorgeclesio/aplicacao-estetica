   ...
   <div class="principal">
    <div class="row">
        ...
        from comanda
            ...
            inner join clientes
            inner join servicos
         on serv_comanda.id_servico=servicos.id and comanda.id=serv_comanda.id_comanda and comanda.id_colaborador=colaboradores.idcolaboradores and clientes.idclientes=comanda.id_cliente
